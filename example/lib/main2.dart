                ...
                Expanded(
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      ...
                      final ganttWidth = (totalDuration.inMicroseconds / visibleDuration.inMicroseconds) *
                          ...
                          child: LegacyGanttChartWidget(
                            ...
                            onTaskUpdate: (task, newStart, newEnd) {
                              ...
                              setState(() {
                                ...
                                final index = _tasks.indexWhere((t) => t.id == task.id); // Use task.id to find the right one
                                if (index != -1) {
